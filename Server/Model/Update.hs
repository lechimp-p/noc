...
data UserUpdateType n
    ...
    | SetUserContact Contact            (() -> n) 
    | RmUserContactTo UserId            (() -> n) 
...
setUserContact :: Member Update r => UserId -> Contact -> Eff r ()
setUserContact uid o = userUpdate uid (SetUserContact o)

rmUserContactTo :: Member Update r => UserId -> UserId -> Eff r ()
rmUserContactTo uid o = userUpdate uid (RmUserContactTo o)
